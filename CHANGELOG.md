...
- portable reasoning roles, each with an inline safeguard summary;
- implementation and field-feedback templates with a privacy warning at the top;
- a synthetic worked example;
- contribution and governance documentation; and
- structured GitHub issue forms for implementation feedback and framework challenges.

This release is exploratory and unvalidated.

No scoring system, predictive model, clinical protocol, automated decision process, participant ranking method, eligibility mechanism, sentencing mechanism, or universal intervention sequence is included.
